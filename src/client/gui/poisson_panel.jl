function draw_poisson_panel(app::AppData, sock::Comm.SocClient)
    if CImGui.TreeNode("Poisson Patterns")
        ...
        app.buffer = string(Model.firing_rate(app.model))
        ...
        app.buffer = string(Model.poisson_pattern_min(app.model))
        ...
        app.buffer = string(Model.poisson_pattern_max(app.model))
        ...
        # Row 2 *****************************************************
        app.buffer = string(Model.poisson_pattern_spread(app.model))
