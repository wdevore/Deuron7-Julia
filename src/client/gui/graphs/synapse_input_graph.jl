...
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
# This graph is for debugging only.
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
mutable struct SynapticInputGraph <: AbstractGraph
    show_vertical_t_bar_markers::Bool
    time_pos::Int64

    function SynapticInputGraph()
        o = new()
...
function draw_header(graph::SynapticInputGraph, gui_data::Gui.GuiData, model::Model.ModelData)
    if CImGui.TreeNode("Controls##21")
        ...
        @c CImGui.DragIntRange2("Range##21", &begin_v, &end_v, 1, 1, duration, "Start: %d", "End: %d")
...
function draw_spikes(graph::SynapticInputGraph, gui_data::Gui.GuiData,
    ...
    for id in 1:synapses
        ...
        syn_data = samples.syn_input_samples.data[id]
        synaptic_samples = syn_data.samples
...
function draw_graph(graph::SynapticInputGraph, gui_data::Gui.GuiData, model::Model.ModelData, samples::Model.Samples)
...
function draw(graph::SynapticInputGraph, gui_data::Gui.GuiData, model::Model.ModelData, samples::Model.Samples, vert_pos::Int64)
    ...
    CImGui.Begin("Synapse Input Merger Graph")
