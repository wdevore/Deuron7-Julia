...
# a curve.
# The data is loaded ???
mutable struct SynapseWeightGraph <: AbstractGraph
    show_vertical_t_bar_markers::Bool
    time_pos::Int64
    value::Float64

    function SynapseWeightGraph()
        o = new()
...
function draw_header(graph::SynapseWeightGraph, gui_data::Gui.GuiData, model::Model.ModelData)
    if CImGui.TreeNode("Controls##5")
        ...
        @c CImGui.DragIntRange2("Range##5", &begin_v, &end_v, 1, 1, duration, "Start: %d", "End: %d")
        ...
        @c CImGui.SliderInt("Synapse##5", &active, 1, synapses)
...
function draw_data(graph::SynapseWeightGraph, gui_data::Gui.GuiData,
    ...
    data_samples = samples.syn_weight_samples.data[syn_id]
...
function draw_graph(graph::SynapseWeightGraph, gui_data::Gui.GuiData, model::Model.ModelData, samples::Model.Samples)
...
function draw(graph::SynapseWeightGraph, gui_data::Gui.GuiData, model::Model.ModelData, samples::Model.Samples, vert_pos::Int64)
    ...
    CImGui.Begin("Synapse Weights Graph")
